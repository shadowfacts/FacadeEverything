 ...
 * @author shadowfacts
 */
class ContainerAssemblyTable(pos: BlockPos, playerInv: InventoryPlayer, table: TileEntityAssemblyTable): ContainerBase(pos) {
	...
	init {
		...
		addSlotToContainer(SlotTable(table, table.output, 0, 133, 35))
	...
	class SlotTable(val table: TileEntityAssemblyTable, handler: IItemHandler, id: Int, x: Int, y: Int): SlotItemHandler(handler, id, x, y) {
